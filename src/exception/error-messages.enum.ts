export enum ErrorMessages {
  ...
  CONVERSATION_USER_IDS_NOT_EMPTY = 'Danh sách ID người dùng không được rỗng',
  ...
  CONVERSATION_ALREADY_IN_GROUP = 'Tất cả người dùng với các ID {alreadyInGroup} đã là thành viên của nhóm',
  CONVERSATION_ALREADY_IN_GROUP_PARTIAL = 'Người dùng với ID {alreadyInGroup} đã là thành viên của nhóm. Những người dùng còn lại (nếu có) sẽ được thêm vào nhóm',
  ...
  CONVERSATION_CANNOT_UPDATE_ADMIN_TO_SELF = 'Người dùng với ID {adminId} đã là admin của nhóm rồi',
  CONVERSATION_NOT_GROUP_OR_TOO_SMALL = 'Cuộc trò chuyện hiện tại chỉ là 1-1, không phải là cuộc trò chuyện nhóm',
  CONVERSATION_CANNOT_ADD_SELF = 'Người dùng với ID {userId} không thể tự thêm chính mình vào nhóm',
  CONVERSATION_ADMIN_OR_MEMBER_REQUIRED = 'Bạn không phải là admin của nhóm này và không thể xóa người khác',
  CONVERSATION_ADMIN_CANNOT_REMOVE_SELF = 'Admin không thể tự xóa chính mình khỏi nhóm. Vui lòng chuyển quyền admin cho thành viên khác trước.',
  ...
  MESSAGE_DELETE_FORBIDDEN = 'Tin nhắn không phải của bạn nên bạn không có quyền xóa tin nhắn này',
